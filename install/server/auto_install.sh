...
source /etc/profile
/usr/bin/mysql -e "insert into monster.accounts_userinfo (password,username,email,is_active,is_superuser) values ('pbkdf2_sha256$36000$8Ers5a8PavIY$EbuUvdsPAwtZYVLDeH9KSGFVIQDeEjG0Q2+prmUIFvQ=','root','monster0812@gmail.com',1,1);"
